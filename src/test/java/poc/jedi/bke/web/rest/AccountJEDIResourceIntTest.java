package poc.jedi.bke.web.rest;

import poc.jedi.bke.PocJediBkeApp;

import poc.jedi.bke.domain.AccountJEDI;
import poc.jedi.bke.repository.AccountJEDIRepository;
import poc.jedi.bke.repository.search.AccountJEDISearchRepository;
import poc.jedi.bke.service.AccountJEDIService;
import poc.jedi.bke.service.dto.AccountJEDIDTO;
import poc.jedi.bke.service.mapper.AccountJEDIMapper;
import poc.jedi.bke.web.rest.errors.ExceptionTranslator;
...
import static poc.jedi.bke.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = PocJediBkeApp.class)
public class AccountJEDIResourceIntTest {
    ...
    /**
     * This repository is mocked in the poc.jedi.bke.repository.search test package.
     *
     * @see poc.jedi.bke.repository.search.AccountJEDISearchRepositoryMockConfiguration
     */
    @Autowired
